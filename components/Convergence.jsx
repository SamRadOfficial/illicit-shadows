  ...
  return (
    <>
      ...
      <figure className="convfig">
        ...
        <figcaption><a href="/images/convergence-map.svg" target="_blank" rel="noopener noreferrer">Open full size</a> &middot; Illicit economies of the Shadowverse &middot; <b>#EverythingIsConnected</b></figcaption>
      </figure>
    </>
  );
}
