...
- **MISTIC is the platform and the institute. Project Helix is its predictive convergence system.
  Helix.AI is the software that runs it.** Use all three in that relationship or none.
